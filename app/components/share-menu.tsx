...
export default function ShareMenu({ title, description, recipeId }: ShareMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 min-w-[200px] z-50">
          <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Share Recipe</span>
            <button 
          ...
          <div className="border-t border-gray-100 dark:border-gray-700 mt-1 pt-1">
            ...
            >
              ...
              <span className="text-gray-700 dark:text-gray-200">Share on X</span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 dark:text-gray-200">Share on Telegram</span>
            </button>
          </div>
        </div>
      )}
